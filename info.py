...
PRIME_LOGO = (environ.get('PRIME_LOGO', 'https://i.ibb.co/BqQQLV8/pay-to-yeasin.jpg'))

# payment
QR_CODE_IMG = environ.get('QR_CODE_IMG','https://i.ibb.co/BqQQLV8/pay-to-yeasin.jpg') #add url link of your qr code to recieve money - use telegraph bot or other source to get image
...
# Others
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/haw_to_download_Movies') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'LazyDeveloper')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "False")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [CTG MOVIES™](https://t.me/+BLqKWUPPRdc1NTA1)</b>⚡\n\n📂<b>File Name:</b> ⪧ {file_caption} \n <b>Size: </b>{file_size}\n\n❤")
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','CTG_MOVIES_ADMIN') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','+j8OaZzlI3uE4MTA9') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','+j8OaZzlI3uE4MTA9') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','+j8OaZzlI3uE4MTA9')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "ctg_movies") #[ without @ ]
...
DOWNLOAD_TEXT_URL = "https://t.me/haw_to_download_Movies"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/+j8OaZzlI3uE4MTA9"
